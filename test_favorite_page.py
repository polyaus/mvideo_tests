from conftest import LOGIN_PAGE_URL, PRODUCT_PAGE_URL_1, PRODUCT_PAGE_URL_2, FAVORITE_PAGE_URL
...
class TestsWithoutLogin:
    ...
    def test_favorite_list_is_empty_from_favorite_list(self):
        favorite_page = FavoritePage(self.browser, FAVORITE_PAGE_URL)
        favorite_page.favorite_list_is_empty_from_favorite_list()
    ...
    def test_favorite_list_is_not_empty(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
    ...
    def test_delete_product_from_favorite_list(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
    ...
    def test_add_two_product_in_favorite_list(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
    ...
    def test_delete_first_added_product_from_favorite_list(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
    ...
    def test_delete_all_two_products_from_favorite_list(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
...
class TestUserCases:
    ...
    def test_authorization_after_add_one_product_in_favorite_list(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
    ...
    def test_add_product_to_favorite_is_not_visible_outside(self):
        login_page = LoginPage(self.browser, LOGIN_PAGE_URL)
        login_page.open_form_authorization()
        login_page.enter_user_data_for_authorization()
        login_page.open_user_cabinet()
    ...
    def test_add_two_products_to_favorite_auth_user(self):
        product_page = ProductPage(self.browser, PRODUCT_PAGE_URL_1)
        product_page.favorite_is_empty()
        product_page.add_favorite_product()
        product_page.in_favorite_list_one_product()
